  ...
  void callbacks_t::keyboard_cb(unsigned char key, int x, int y)
  {
    ...
    case 'w':
      (test)->launch();
          ...
          //dominos_t::launcherJoint.enableMotor = true;
          //dominos_t::launcherJoint.maxMotorForce = 500;//this is a powerful machine after all...
          //dominos_t::launcherJoint.motorSpeed = 5;//5 units per second in positive axis direction
